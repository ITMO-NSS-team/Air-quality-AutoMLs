...
try:
    ...
    print(
        "Try installing Chronos via pip install "
...
def load_station_data(
    ...
    dates = pd.to_datetime(
        np.load(f"../data/npy_datasets/{station}_{data_type}_target_dates.npy")
    )
...
if __name__ == "__main__":
    ...
    with tqdm(stations, desc="Evaluating stations") as pbar:
        for station in pbar:
            ...
            train_mae, train_mse, test_mae, test_mse = evaluate_station(
                pipeline, station, CHRONOS_MODEL, pbar
            )
