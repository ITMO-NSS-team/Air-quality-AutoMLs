...
for station in stations:
    ...
    pipeline.fit(
        train_input,
        n_jobs=config.automl.fedot.predictor_init_kwargs["n_jobs"]
    )
    ...
    results_df.to_csv(f'./baselines/results/fedotllm/univariate/{station}_metrics.csv', index=False)
